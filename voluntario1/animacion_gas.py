...
file_out = "animacion_gas" # Nombre del fichero de salida (sin extensión)
...
def update(j_frame, frames_data, planet_points, planet_trails, show_trail, length_trail):
...
if nframes > 1:
    ...
    animation = FuncAnimation(
            ...
            fargs=(frames_data, planet_points, planet_trails, show_trail, length_trail),
