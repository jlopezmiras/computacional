...
file_out = "animacion_estado_solido" # Nombre del fichero de salida (sin extensión)
...
#title = ax.text(0.5, 0.95, "", transform=ax.transAxes, ha="center", horizontalalignment='center',
    # verticalalignment='center')

#ax.annotate(f"Tiempo: {0.00:.0f}", (0.5, 1.03), xycoords="axes fraction", ha="center")
...
def update(j_frame, frames_data, planet_points, planet_trails, show_trail, length_trail, time):
    ...
    #title.set_text(f"Tiempo: {time[j_frame]:.1f}")
...
if nframes > 1:
    ...
    animation = FuncAnimation(
            ...
            fargs=(frames_data, planet_points, planet_trails, show_trail, length_trail, time),
